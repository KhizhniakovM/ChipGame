...
class GameStartView: GameView {
    ...
    lazy var myKingChip: UIImageView = {
        ...
        chip.image = UIImage(named: "MyKingChip")
    ...
    lazy var myFirstDefChip: UIImageView = {
        let chip = UIImageView()
        chip.translatesAutoresizingMaskIntoConstraints = false
        chip.image = UIImage(named: "MyWhiteChip")
        return chip
    }()
    ...
    lazy var enemyKingChip: UIImageView = {
        let chip = UIImageView()
        chip.translatesAutoresizingMaskIntoConstraints = false
        chip.image = UIImage(named: "EnemyKingChip")
        return chip
    }()
    lazy var enemyFirstDefChip: UIImageView = {
        let chip = UIImageView()
        chip.translatesAutoresizingMaskIntoConstraints = false
        chip.image = UIImage(named: "EnemyWhiteChip")
        return chip
    }()
